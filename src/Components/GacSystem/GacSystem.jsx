...
import './GacSystem.css';

function GacSystem() {
  return (
    <div className="container-fluid gac-system-container overflow-hidden">
      ...
      <div className="back-icon-container d-none d-lg-block animate-from-left ">
        ...
        {/* Header Section */}
        <div className="header-section text-center mb-1 mt-3 text-dark ms-0 ms-lg-3 ">
          <h1 className="mb-2 animate-from-top overflow-hidden">Welcome to McLarens Group</h1>
          <p className="lead animate-from-top overflow-hidden">Providing Services for Over 70 Years</p>
          <button type="button" className="custom-btn animate-from-top overflow-hidden" onClick={() => window.open('https://www.mclarens.lk/', '_blank')}>
            Group Website
          </button>
        </div>
        ...
        <div className='col-lg-2 d-none d-lg-block'></div>
          <div className="col-lg-2 col-md-4 col-sm-12 mt-5 mt-lg-0 animate-from-right overflow-hidden">
            <div className="card text-center shadow-sm" onClick={() => window.open('https://pettycash.gac.lk', '_blank')}>
              <div className="card-body">
                <FontAwesomeIcon icon={faMoneyBillWave} className="icon-style" />
                <h5 className="card-title mt-1">Petty Cash</h5>
              </div>
            </div>
          </div>
          <div className='col-lg-1 d-none d-lg-block'></div>
          <div className="col-lg-2 col-md-4 col-sm-12 mt-5 mt-lg-0 animate-from-top overflow-hidden">
            <div className="card text-center shadow-sm" onClick={() => window.open('https://tripbonus.gac.lk', '_blank')}>
              <div className="card-body">
                <FontAwesomeIcon icon={faShip} className="icon-style" />
                <h5 className="card-title mt-1">Trip Bonus</h5>
              </div>
            </div>
          </div>
          <div className='col-lg-1 d-none d-lg-block'></div>
          <div className="col-lg-2 col-md-4 col-sm-12 mt-5 mt-lg-0 animate-from-left overflow-hidden">
            <div className="card text-center shadow-sm" onClick={() => window.open('https://opsjobtracker.gac.lk/', '_blank')}>
              <div className="card-body">
                <FontAwesomeIcon icon={faFerry} className="icon-style" />
                <h5 className="card-title mt-1">OPS Job Tracker</h5>
              </div>
            </div>
          </div>
          <div className='col-lg-2 d-none d-lg-block'></div>
